...
class paymentFormToolbox {
    ...
    /**************** CLASS PROPERTIES **************/
    // Container for Sogecommerce user's account informations
    public $account;
    public $debug;
    ...
    /**
     * Constructor, stores the Sogecommerce user's account informations
     * @param $args array(
     *    $shopID => string, the account site id as provided by Sogecommerce
     *    $certTest => string, certificate, test-version
     *    $certProd => string, certificate, production-version
     *    $ctxMode => string ("TEST" or "PRODUCTION"), the Sogecommerce mode to operate
     *    $platform => string URL
     * )
     */
    ...
    /**
     * getFormFields
     * Utility function, returns all the mandatory data needed by a Sogecommerce form payment
     * as an array
     *
     ...
     * during IPN request from Sogecommerce plat-form
     *
     * @param $fields array, the data received from Sogecommerce, usually the _POST PHP super-global
     *
     * @return array|bool
     */
     ...
     *  for Sogecommerce signature
     *
     * @param $fields array data received from Sogecommerce
     * (typically $_POST)
     *
    ...
    public function getIpn(){
        ...
        if( isset($_POST['vads_trans_status'])){
            ...
            try {
                ...
                $error_msg= '### ERROR - An exception raised during IPN Sogecommerce process:';
