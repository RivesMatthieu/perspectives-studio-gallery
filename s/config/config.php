 ...
 *
 * Ask support at https://sogecommerce.societegenerale.eu/doc/ for your platform URL if you don't know it
 *
 * IPN (optional)
...
$args = array(
    'shopID'    => '84082328', // shopID
    'certTest'  => 'JszgZXfHmRyZYJUv', // certificate, TEST-version
    'certProd'  => '[***CHANGE-ME***]', // certificate, PRODUCTION-version
    'ctxMode'   => 'TEST',              // PRODUCTION || TEST
    'platform'  => 'https://sogecommerce.societegenerale.eu/vads-payment/', // Platform URL
