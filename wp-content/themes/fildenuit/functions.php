...
// Déclaration JS
function fildenuit_register_assets() {
    wp_enqueue_script( 'filedenuit', get_stylesheet_directory_uri() . '/js/app.js' );
}

add_action( 'wp_enqueue_scripts', 'fildenuit_register_assets' )
