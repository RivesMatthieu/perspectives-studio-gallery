  ...
  <div class="wfte_invoice-header clearfix">
      ...
      <div class="wfte_invoice-header_top clearfix">
        <div class="clearfix">
          ...
          <div class="wfte_addrss_fields wfte_invoice_data float_right">
...
.wfte_invoice_number{ font-size:14px; }
.wfte_creditnote_number{ font-size:14px; font-weight:bold; }
.wfte_order_number{ font-size:14px; font-weight:bold; }
.wfte_invoice_date{ font-size:14px;}
.wfte_order_date{ font-size:14px;}
.wfte_invoice_data{ padding:30px; width:33%; background-color:#f3f3f3; }
...
td.wfte_product_table_payment_total_label{ text-align:end; height:36px; padding:0px 5px; line-height:10px;}
