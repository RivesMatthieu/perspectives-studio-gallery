<div class="wfte_rtl_main wfte_invoice-main">
  ...
  <table class="wfte_payment_summary_table wfte_product_table">
    ...
    <div class="wfte_barcode clearfix wfte_text_left">
        <img class="float_left" src="[wfte_barcode_url]" style="">
    </div>
...
.wfte_product_table_body td{padding:4px 5px;}
.wfte_payment_summary_table_body td{padding:8px 5px;}
.wfte_product_table_head{background-color:#212529;}
.wfte_product_table_head th{border:solid 1px #212529; height:36px; padding:0px 5px; color:inherit; font-size:.75rem; text-align:center; line-height:10px;}
