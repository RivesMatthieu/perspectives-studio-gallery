<div class="wfte_rtl_main wfte_invoice-main">
  <div class="wfte_invoice-header clearfix">
      ...
      <div class="wfte_addrss_field_main clearfix">
         ...
         <div class="wfte_addrss_fields float_left wfte_invoice_data">
...
.wfte_invoice_data{ padding:0px 15px; }
.wfte_addrss_field_main{width:100%; font-size:12px; padding-top:25px; }
.wfte_addrss_fields{ width:25%; padding:0px 5px;}
...
.wfte_product_table_head th{height:36px; padding:0px 5px; color:inherit; font-size:.75rem; text-align:center; line-height:10px;}
