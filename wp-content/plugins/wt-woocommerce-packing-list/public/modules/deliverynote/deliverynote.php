...
class Wf_Woocommerce_Packing_List_Deliverynote
{
	...
	*/
	...
	public function add_email_print_buttons($html,$order,$order_id, $email_obj)
	{
        ...
        {
            Wf_Woocommerce_Packing_List::generate_print_button_for_user($order, $order_id, 'print_'.$this->module_base, esc_html__('Print Delivery note','wf-woocommerce-packing-list'), true); 
        }
	    return $html;
	}
