...
class BNPMercanetCw_Vpay extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'vpay';
	public $admin_title = 'V PAY';
	public $title = 'V PAY';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_vpay_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/vpay.png')
		);
		parent::__construct();
	}
