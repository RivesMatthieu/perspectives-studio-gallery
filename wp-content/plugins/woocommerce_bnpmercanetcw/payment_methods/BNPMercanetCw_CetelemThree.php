...
class BNPMercanetCw_CetelemThree extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'cetelemthree';
	public $admin_title = 'Cetelem Full CB - 3CB';
	public $title = 'Cetelem Full CB - 3CB';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_cetelemthree_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/cetelemthree.png')
		);
		parent::__construct();
	}
