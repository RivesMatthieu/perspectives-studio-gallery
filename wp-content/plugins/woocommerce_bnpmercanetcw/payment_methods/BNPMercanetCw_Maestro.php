...
class BNPMercanetCw_Maestro extends BNPMercanetCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_maestro_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/maestro.png')
		);
		parent::__construct();
	}
