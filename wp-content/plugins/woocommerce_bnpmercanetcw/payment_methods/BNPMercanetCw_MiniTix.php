...
class BNPMercanetCw_MiniTix extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'minitix';
	public $admin_title = 'MiniTix';
	public $title = 'MiniTix';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_minitix_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/minitix.png')
		);
		parent::__construct();
	}
