...
class BNPMercanetCw_Paytrail extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'paytrail';
	public $admin_title = 'Paytrail';
	public $title = 'Paytrail';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_paytrail_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/paytrail.png')
		);
		parent::__construct();
	}
