...
class BNPMercanetCw_Acceptgiro extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'acceptgiro';
	public $admin_title = 'Acceptgiro';
	public $title = 'Acceptgiro';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_acceptgiro_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/acceptgiro.png')
		);
		parent::__construct();
	}
