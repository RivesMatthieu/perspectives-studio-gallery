...
class BNPMercanetCw_MasterPass extends BNPMercanetCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_masterpass_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/masterpass.png')
		);
		parent::__construct();
	}
