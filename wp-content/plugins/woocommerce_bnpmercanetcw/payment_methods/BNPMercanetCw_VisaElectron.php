...
class BNPMercanetCw_VisaElectron extends BNPMercanetCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_visaelectron_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/visaelectron.png')
		);
		parent::__construct();
	}
