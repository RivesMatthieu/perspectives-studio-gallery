...
class BNPMercanetCw_CetelemFour extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'cetelemfour';
	public $admin_title = 'Cetelem Full CB - 4CB';
	public $title = 'Cetelem Full CB - 4CB';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_cetelemfour_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/cetelemfour.png')
		);
		parent::__construct();
	}
