...
class BNPMercanetCw_Paylib extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'paylib';
	public $admin_title = 'paylib';
	public $title = 'paylib';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_paylib_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/paylib.png')
		);
		parent::__construct();
	}
