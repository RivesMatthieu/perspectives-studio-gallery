...
class BNPMercanetCw_PayPal extends BNPMercanetCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_paypal_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/paypal.png')
		);
		parent::__construct();
	}
