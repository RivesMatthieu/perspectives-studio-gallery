...
class BNPMercanetCw_DirectDebitsSepa extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'directdebitssepa';
	public $admin_title = 'Sepa Direct Debits';
	public $title = 'Sepa Direct Debits';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_directdebitssepa_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/directdebitssepa.png')
		);
		parent::__construct();
	}
