...
class BNPMercanetCw_CarteBancaire extends BNPMercanetCw_PaymentMethod
{
	public $machineName = 'cartebancaire';
	public $admin_title = 'Carte Bancaire';
	public $title = 'Carte Bancaire';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_cartebancaire_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/cartebancaire.png')
		);
		parent::__construct();
	}
