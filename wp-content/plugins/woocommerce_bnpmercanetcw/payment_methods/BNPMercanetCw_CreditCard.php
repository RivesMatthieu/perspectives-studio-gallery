...
class BNPMercanetCw_CreditCard extends BNPMercanetCw_PaymentMethod
{
		...
		return array(
			'capturing' => array(
 			...
 			'credit_card_brands' => array(
				'title' => __("Credit Card Brands", 'woocommerce_bnpmercanetcw'),
 				'default' => array(
					0 => 'visa',
 					1 => 'mastercard',
 					2 => 'americanexpress',
 				...
 				'description' => __("You can restrict the usable cards for this payment method by this setting. Only the selected one can be used by the customer.", 'woocommerce_bnpmercanetcw'),
 				'cwType' => 'multiselect',
 				'type' => 'multiselect',
 				'options' => array(
					'visa' => __("VISA", 'woocommerce_bnpmercanetcw'),
 					'mastercard' => __("MasterCard", 'woocommerce_bnpmercanetcw'),
 					'americanexpress' => __("American Express", 'woocommerce_bnpmercanetcw'),
 					'maestro' => __("Maestro", 'woocommerce_bnpmercanetcw'),
 					'vpay' => __("V PAY", 'woocommerce_bnpmercanetcw'),
 					'visaelectron' => __("Visa Electron", 'woocommerce_bnpmercanetcw'),
 					'cartebancaire' => __("Carte Bancaire", 'woocommerce_bnpmercanetcw'),
 				),
 			),
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_creditcard_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/creditcard.png')
		);
		parent::__construct();
	}
