...
class BNPMercanetCw_AmericanExpress extends BNPMercanetCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_bnpmercanetcw_americanexpress_icon', 
			BNPMercanetCw_Util::getResourcesUrl('icons/americanexpress.png')
		);
		parent::__construct();
	}
