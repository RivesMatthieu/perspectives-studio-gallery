 ...
 *
 */
class BNPMercanetCw_Controller_Authorize extends BNPMercanetCw_Controller_Abstract {
	...
	public function indexAction() {
		...
		BNPMercanetCw_Util::getTransactionHandler()->persistTransactionObject($transactionObject);
