...
require_once 'BNPMercanetCw/EndpointAdapter.php';
 ...
 *
 */
class BNPMercanetCw_Controller_Endpoint extends BNPMercanetCw_Controller_Abstract {
	...
	public function indexAction() {
		...
		$adapter = new BNPMercanetCw_EndpointAdapter();
		
		$dispatcher = new Customweb_Payment_Endpoint_Dispatcher($adapter, $container, $packages);
		$response = $dispatcher->dispatch(BNPMercanetCw_ContextRequest::getInstance());
