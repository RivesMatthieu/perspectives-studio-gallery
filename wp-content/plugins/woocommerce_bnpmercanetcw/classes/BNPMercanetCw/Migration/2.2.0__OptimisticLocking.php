...
class BNPMercanetCw_Migration_2_2_0 implements Customweb_Database_Migration_IScript {
	...
	public function execute(Customweb_Database_IDriver $driver){
		...
		$tableNameECC = $entityManager->getTableNameForEntityByClassName('BNPMercanetCw_Entity_ExternalCheckoutContext');
		...
		$tableName = $wpdb->prefix . 'woocommerce_bnpmercanetcw_customer_contexts';
		$tableNameNew = $wpdb->prefix . 'woocommerce_bnpmercanetcw_cc';
		...
		$tableNamePCC = $entityManager->getTableNameForEntityByClassName('BNPMercanetCw_Entity_PaymentCustomerContext');
