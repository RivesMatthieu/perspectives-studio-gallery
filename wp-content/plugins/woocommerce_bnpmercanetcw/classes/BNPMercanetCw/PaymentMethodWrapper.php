...
class BNPMercanetCw_PaymentMethodWrapper implements Customweb_Payment_Authorization_IPaymentMethod {
	...
	/**
	 * @var BNPMercanetCw_PaymentMethod
	 */
	private $method = null;
	
	public function __construct(BNPMercanetCw_PaymentMethod $method) {
	...
	protected function getMethod() {
		if ($this->method === null) {
			...
			BNPMercanetCw_Util::includePaymentMethod($paymentMethod);
