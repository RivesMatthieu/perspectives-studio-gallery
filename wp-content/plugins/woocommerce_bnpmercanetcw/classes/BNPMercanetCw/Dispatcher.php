 ...
 *
 */
class BNPMercanetCw_Dispatcher
{
	...
	public function dispatch() {
		try {
			$request = BNPMercanetCw_ContextRequest::getInstance();
	...
	private function getControllerInstance() {
		...
		$expectedClassName = 'BNPMercanetCw_Controller_' . Customweb_Core_Util_String::ucFirst($this->controllerName);
		$effectiveClass = null;
