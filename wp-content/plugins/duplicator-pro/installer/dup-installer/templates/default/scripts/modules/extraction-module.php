...
?>
<script>
    DUPX.startAjaxExtraction = function (isTheFirstCall, nextStepParams)
    {
        if (isTheFirstCall) {
        ...
        let extractionAction = <?php echo DupProSnapJsonU::wp_json_encode(DUPX_Ctrl_ajax::ACTION_EXTRACTION); ?>;
        let extractionToken = <?php echo DupProSnapJsonU::wp_json_encode(DUPX_Ctrl_ajax::generateToken(DUPX_Ctrl_ajax::ACTION_EXTRACTION)); ?>;
                ...
                function (data, textStatus, jqXHR) {
                    ...
                    switch (data.actionData.pass) {
                        case 1:
                            ...
                            break;
                        case - 1:
                            DUPX.startAjaxExtraction(false, nextStepParams);
                            break;
                        default:
                            const result = {
                                'success': false,
