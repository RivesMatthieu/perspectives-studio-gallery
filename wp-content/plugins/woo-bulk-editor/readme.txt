...
WooCommerce Bulk Editor and Products Manager Professional - WordPress plugin for managing and bulk edit WooCommerce products data in the robust and flexible way!

== Description ==

**WOOBE - Products Bulk Editor and Products Manager for WooCommerce** (WOOBE) is WordPress plugin for WooCommerce, created for managing and bulk edit WooCommerce products in the robust and flexible way! Be professionals with managing data of your woocommerce e-shop!

Latest PHP 7.4.x - FULL COMPATIBILITY! WooCommerce compatibility: from v.3.4 to the latest woocommerce version.
