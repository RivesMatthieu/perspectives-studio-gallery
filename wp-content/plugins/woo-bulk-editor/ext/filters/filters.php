    ...
    public function woobe_tools_panel_buttons_end() {
        ...
        &nbsp;|&nbsp;<span>
            ...
            $search_options = apply_filters('woobe_quick_search_options', array(
                'post_title' => __('Title', 'woo-bulk-editor'),
                'sku' => __('SKU', 'woo-bulk-editor'),
                'post__in' => __('ID', 'woo-bulk-editor'),
            ));
            ...
            <div  id="woobe_filter_form_tools_panel">
                <div class='tools_panel_filter-unit-wrap'>
                    <div class="col-lg-6">
                        <input type="text" placeholder="<?php _e('quick search by ...', 'woo-bulk-editor') ?>" name="woobe_filter_form_tools_value" value="" />
                    </div>
                    <div class="col-lg-2">
