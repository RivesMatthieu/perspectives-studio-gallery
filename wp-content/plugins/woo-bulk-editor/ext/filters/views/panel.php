...
<div style="clear: both;"></div>
<br />
<a href="https://bulk-editor.com/document/filters/" target="_blank" class="button button-primary woobe_btn_order"><span class="icon-book"></span>&nbsp;<?php _e('Documentation', 'woo-bulk-editor') ?></a>
<br />
...
function woobe_filter_draw_text() {
    ...
    $behavior_options = array(
        ...
        'empty' => __('Empty', 'woo-bulk-editor'),
    ...
    $filter_keys = array(
        ...
        'product_url' => array(
            'placeholder' => __('Product URL ...', 'woo-bulk-editor'),
            'behavior_options' => $behavior_options
        ),        
    );
            ...
            if($item["field_type"]=="meta" AND $item["edit_view"]=="calendar"){
              ?>  
                <div class="col-lg-6" style="position: relative; margin-bottom: 2px;">
                    <div style="padding-right: 1px">
                        <?php
                        echo WOOBE_HELPER::draw_calendar(0,sprintf(__('%s from', 'woo-bulk-editor'), $item["title"]) , $item["meta_key"].'_from', '', 'woobe_filter['.$item["meta_key"].'_from]', true,true);
                        ?>
                    </div>
                </div>
                <div class="col-lg-6" style="position: relative; margin-bottom: 2px;">
                    <div style="padding-left: 1px">
                        <?php
                        echo WOOBE_HELPER::draw_calendar(0, sprintf(__('%s to', 'woo-bulk-editor'), $item["title"]), $item["meta_key"].'_to', '', 'woobe_filter['.$item["meta_key"].'_to]', true,true);
                        ?>
                    </div>
                </div> 
            <?php              
