...
<div class="notice notice-info">
    <p>
        <?php _e('Note: you can change columns set and then set their order in the tab Settings, then save it as columns profile which in future will help you with exporting of the products data format quickly without necessary each time set columns order and their set!', 'woo-bulk-editor') ?>    
    </p>
</div>
<br />
<div class="col-lg-12">
...
<div class="col-lg-6">
    ...
    <a href="javascript: woobe_export_to_xml();void(0);" class="button button-primary button-large woobe_export_products_btn"><?php _e('Export to XML', 'woo-bulk-editor') ?></a>
    ...
    <a href="<?php echo $download_link ?>" target="_blank" class="button button-primary button-large woobe_export_products_btn_down" style="display: none; color: greenyellow;"><span class="icon-download"></span>&nbsp;<?php _e('download CSV', 'woo-bulk-editor') ?>&nbsp;<span class="icon-download"></span></a>
    <a href="<?php echo $download_link_xml ?>" target="_blank" class="button button-primary button-large woobe_export_products_btn_down_xml" style="display: none; color: greenyellow;"><span class="icon-download"></span>&nbsp;<?php _e('download XML', 'woo-bulk-editor') ?>&nbsp;<span class="icon-download"></span></a>
...
<div style="clear: both;"></div>
<br />
<a href="https://bulk-editor.com/document/woocommerce-products-export/" target="_blank" class="button button-primary woobe_btn_order"><span class="icon-book"></span>&nbsp;<?php _e('Documentation', 'woo-bulk-editor') ?></a>
<br />
