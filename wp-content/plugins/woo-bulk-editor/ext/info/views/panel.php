...
<b>
    <?php
    printf(esc_html('The plugin has %s and "%s" list. Also if you have troubles you can %s!', 'woo-bulk-editor'), WOOBE_HELPER::draw_link(array(
                'href' => 'https://bulk-editor.com/documentation/',
                'title' => esc_html('documentation', 'woo-bulk-editor'),
                'target' => '_blank'
            )), WOOBE_HELPER::draw_link(array(
                'href' => 'https://bulk-editor.com/how-to-list/',
                'title' => esc_html('How to', 'woo-bulk-editor'),
                'target' => '_blank'
            )), WOOBE_HELPER::draw_link(array(
                'href' => 'https://pluginus.net/support/forum/woobe-woocommerce-bulk-editor-professional/',
                'title' => '<b style="color: orange;">' . esc_html('ask for support here', 'woo-bulk-editor') . '</b>',
...
<ol>
    ...
    <li><?php
        printf(__('How to %s by bulk operation', 'woo-bulk-editor'), WOOBE_HELPER::draw_link(array(
                    'href' => 'https://bulk-editor.com/howto/how-to-remove-sale-prices-by-bulk-operation/',
                    'title' => __('remove sale prices', 'woo-bulk-editor'),
                    'target' => '_blank',
                    'style' => 'color: red;'
        )))
        ?>
...
<ul>
    <li><?php _e('Recommended min RAM', 'woo-bulk-editor') ?>: 256 MB</li>
