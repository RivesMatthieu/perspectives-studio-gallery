...
global $WOOBE;
?>
<h4 style="margin-bottom: 2px;" class="woobe-documentation"><a href="https://bulk-editor.com/document/history/" target="_blank" class="button button-primary"><span class="icon-book"></span></a>&nbsp;<?php _e('History', 'woo-bulk-editor') ?></h4>
...
<div class="col-lg-12 woobe_history_pagination_cont">
    ...
    <div class="col-lg-12 woobe_history_filters">
        ...
        <div class="col-lg-2" >
            <input type="text" id="woobe_history_filter_field" placeholder="<?php _e('by fields, use comma', 'woo-bulk-editor') ?>" >
        </div>     
        <div class="col-lg-2" >
