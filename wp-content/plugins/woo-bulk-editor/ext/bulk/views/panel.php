...
<div class="woobe_delete_wraper" style="float: right;">
    ...
    <input type="checkbox" id="woobe_bulk_delete_products_btn_fuse" disabled="" value='1'>
...
<?php if ($WOOBE->show_notes): ?>
    ...
    <?php else: ?>
        <label for="woobe_bulk_delete_products_btn_fuse"><?php _e('Bulk deleting', 'woo-bulk-editor') ?></label><br />
    <?php endif; ?>
...
<?php if ($WOOBE->show_notes) : ?>
    ...
    <li>
        ...
        <a href="https://bulk-editor.com/document/woocommerce-products-bulk-edit/" target="_blank" class="button button-primary woobe_btn_order"><span class="icon-book"></span>&nbsp;<?php _e('Documentation', 'woo-bulk-editor') ?></a>
...
function woobe_bulk_draw_add1($fields) {
    ...
    <?php if ($show_field): ?>
        ...
        <?php if ($fields[$current_field_key]['direct']): ?>
                ...
                <div class="col-lg-7">
                    <a href="#" id="woobe_bulk_select_thumb_btn" class="button button-primary woobe_btn_order"><?php _e('select thumbnail', 'woo-bulk-editor') ?></a>
                </div>
                <div style="clear: both;"></div>
            </div>
        </div>
